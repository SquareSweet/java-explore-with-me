...
public class RequestServiceImpl implements RequestService {
    ...
    public RequestDto create(Long eventId, Long userId) {
        ...
        Event event = eventService.getByIdNotMapped(eventId); //trows exception if user does not exist
    ...
    public List<RequestDto> getEventRequests(Long eventId, Long userId) {
        ...
        eventService.getByIdNotMapped(eventId); //trows exception if user does not exist
